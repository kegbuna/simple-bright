                            ...
                            <div class="request-information">
                                ...
                                <div class="left">
                                    <% if(!submission.getType().equals(bundle.getProperty("autoCreatedRequestType"))) {%>
                                        <a class="view-submitted-form templateButton btn btn-success" target="_self" href="<%= bundle.applicationPath()%>ReviewRequest?csrv=<%=submission.getId()%>&excludeByName=Review%20Page&reviewPage=<%= bundle.getProperty("reviewJsp")%>">
                                            View Submitted Form
                                        </a>
                                    <%}%>
                                </div>
                                ...
                                <ul class="list-group activities">
                                    ...
                                    <% for (String treeName : submission.getTaskTreeExecutions(context).keySet()) {%>
                                        ...
                                        <%
                                            ...
                                            else if (task.getDefName().equals(bundle.getProperty("workInfoHandler")))
                                            {
                                                out.print(task.getName());
                                                workOrderId = task.getResult("Work Order Number");
                                        ...
                                        %>
                                            <li class="list-group-item <%= zebraCycle.cycle()%>" data-task-id="<%= task.getId()%>" data-ticket-id="<%= ticketId%>">
                                                <header class="clearfix">
                                                    <h4>
                                                        <%= task.getName()%>
                                                    </h4>
