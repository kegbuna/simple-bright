        ...
        <div class="sticky-footer" style="min-height: 500px;">
            ...
            <section class="container">
                <div id="pageQuestionsForm" class="border rounded">
                    <p>
                        <b>Thank you for submitting a ticket for <%= customerRequest.getTemplateName()%>. Your Ticket ID is <%= customerRequest.getKsr()%>.
                        </b>
                    </p>
                    <p>
                        To track the status of your ticket, click the <a href="<%= bundle.getProperty("submissionsUrl")%>">My Tickets</a> link.
                    </p>
                </div>
            </section>
