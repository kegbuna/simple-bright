...
<html>
    <head>
        ...
        <title>
            <%= bundle.getProperty("siteTitle")%>&nbsp;|&nbsp;Review&nbsp;|&nbsp;<%= customerRequest.getTemplateName()%>
        </title>
    ...
    <body class="loadAllPages_<%=customerSurveyReview.getLoadAllPages()%> review">
        <div class="view-port">
            ...
            <div class="content-slide" data-target="div.navigation-slide">
                ...
                {%> <%@include file="../../core/interface/fragments/reviewBodyContent.jspf"%>
                <%}%>
                <%if (request.getParameter("embedded") == "blar blar")
                {%>
        ...
        <script type="text/javascript">
            parent.document.getElementById('reviewFrame').style.height = '500px';
            $('#reviewContent').css('margin', '0');
            $('.view-port').css('padding','0');
        </script>
    </body>
</html>