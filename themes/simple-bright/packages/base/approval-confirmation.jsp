            ...
            <section class="container">
                <div id="pageQuestionsForm" class="border rounded">
                    <p style="margin-top: 20px;">
                        <b>Thank you for your approval submission.</b>
                    </p>
                    <p>
                        To continue working with approvals, click the <a href="<%= bundle.getProperty("submissionsUrl")%>&type=approvals"><b>My Approvals</b></a> link.
                    </p>
                    <p>
                        Click <a href="<%=bundle.getProperty("homeUrl")%>"><b>here</b></a> to return home.
                    </p>
                </div>
            </section>
