                ...
                columns: [
                    { data: 'name', title: 'Structure', width: '50%', 
                        createdCell: function(td, cellData, rowData) {
                            $(td).wrapInner($('<a>')
                                .attr('href', document.URL+'/'+rowData['class']));
                        }
                    },
                    { data: 'indexes', title: 'Indexes', width: '15%', 'orderSequence': ['desc', 'asc'], 
                        createdCell: function(td, cellData, rowData) {
                            $(td).html($('<a>')
                                .attr('href', document.URL+'/'+rowData['class']+'/indexes')
                                .text(cellData+' Indexes'));
                        }
                    },
                    { data: 'count', title: 'Count', width: '15%', 'orderSequence': ['desc', 'asc'] },
