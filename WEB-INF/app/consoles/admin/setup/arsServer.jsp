...
<tag:application>
    <jsp:attribute name="title">Kinetic | ARS Server</jsp:attribute>
                            ...
                            <div class="row">
                                <div class="col-xs-9">
                                    ...
                                    <ul class="nav nav-pills sub-nav" id="propertiesTabs">
                                        ...
                                        <li class="active"><a href="<%=request.getContextPath()%>/app/admin/setup/ars-server">ARS Server</a></li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="row active tab-pane fade in" id="system">
                                            <div class="col-xs-12">
                                                <form action="<%=request.getContextPath()%>/app/admin/setup/ars-server" id="systemProperties" method="post" role="form"
                                                      data-disable-on-submit="disable-on-submit">
                                                    <div id="arsProperties"></div>

                                                    <div class="form-buttons">
                                                        <button class="btn btn-primary" type="submit">Save ARS Properties</button>
                                                        <a class="btn btn-default" href="<%=request.getContextPath()%>/app/installer/change-server">Change ARS Server</a>
                                                    </div>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                kinetic.ConfigurableProperties({
                    ...
                    prefix: 'Ars',
                    properties: <%= JsonUtils.toJsonString(request.getAttribute("arsProperties")) %>,
