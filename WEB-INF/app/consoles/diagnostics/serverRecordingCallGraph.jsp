            ...
            <div class="row">
                ...
                <div class="col-xs-9">
                    ...
                    <div class="page-header">
                        <h3>
                            ...
                            <form action="<%=request.getContextPath()%>/app/diagnostics/server-monitoring/start" 
                                ...
                                <input type="hidden" id="page" name="page" value="graph"/>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <a class="pull-right" href="call-graph/raw" target="_blank">View Raw</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                <jsp:include page="profiling/callGraph.jsp"/>
                            </div>
                        </div>
                    </div>
                </div>
