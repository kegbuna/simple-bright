...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() + "/resources/js/yui/build/container/assets/skins/sam/container.css"%>" />
...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() + "/resources/css/ks_task_detail.css"%>" />
...
<script type="text/javascript" src="<%=request.getContextPath() + "/resources/js/yui/build/json/json.js"%>"></script>
