service_item "Clinical App Request" do
  ...
  display_name "Lahey-AppRequest"
  header_content nil
  web_server "http://wvremmidt01g1.laheyhealth.org:8090/kinetic/"
  ...
  page "Initial Page",
    ...
    text "Search Buttons", "<div class=\"fleft\" id=\"searchButtons\">\n  <input type=\"button\" value=\"Search\" id=\"b_searchReqFor\" class=\"templateButton\" > \n  <input type=\"button\" value=\"Clear\" id=\"b_clearReqFor\" class=\"templateButton\" > \n  <img id=\"ajax_searchReqFor\" src=\"themes/flyout/common/resources/images/spinner.gif\" alt=\"searching...\" style=\"display:none;\" />\n</div>\n<div class=\"clearfix\"></div>",
      ...
      event "Person Lookup",
        ...
        data_request "CTM:People",
          ...
          :qualification => "'Person ID' = \"<FLD>Search By Person ID;KSe430abed5efcaffd2d57f26c8f6291f249;ANSWER</FLD>\""
    ...
    question "Application", "Select the application", :dynamic_list,
      :field_map_number => "3" do
      bridged_dynamic_list "Products",
        :qualification => "By Prod Cats",
        :label_attribute => "Categorization 3",
        :value_attribute => "Categorization 3" do
        parameter "Cat1", "Software"
      end
    end
    question "Request Details", "Please provide details on your request", :free_text,
      :required,
      :size => "30",
      :rows => "4",
      :field_map_number => "1"
