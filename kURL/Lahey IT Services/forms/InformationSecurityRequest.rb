service_item "Information Security Request" do
  catalog "Lahey IT Services"
  categories "Security Requests"
  type "Template"
  description "Request an application or standard set of applications for installation."
  ...
  page "Initial Page",
    ...
    event "enable people search",
      ...
      :use_bridging,
      :fire_if => "1==1" do
      custom_code "Column.startTemplate();"
      bridged_resource "People",
        :qualification => "Raw"
    end
    section  "Requested For Section",
      :style_class => " border rounded "
    text "Requested For Header", "<i class=\"fa fa-group fa-2x\"></i><h3 class=\"\">User Information</h3>",
      :style_class => " section-header RIF-header text-primary "
    text "Contact Information", "<div id=\"submitterBox\" class=\"col-sm-4 submitter\">\n<address>\n  <strong>Submitted By:</strong><br>\n  <span class=\"full-name\">Test User</span><br>\n  <abbr title=\"Phone\">P:</abbr> <span class=\"phone-number\">(123) 456-7890</span><br>\n  <a href=\"mailto:test@email.com\"><span class=\"email-address\">test@email.com</span></a>\n</address>\n</div>\n<div id=\"customerBox\" class=\"col-sm-4 customer\">\n<address>\n  <strong>Submitted For:  (<a href=\"#\" id=\"changeCustomer\">change</a>)</strong><br>\n  <span class=\"full-name\">Test User</span><br>\n  <abbr title=\"Phone\">P:</abbr> <span class=\"phone-number\">(123) 456-7890</span><br>\n  <a href=\"mailto:test@email.com\"><span class=\"email-address\">test@email.com</span></a>\n</address>\n</div>",
    ...
    text "Search Buttons", "<div class=\"fleft\" id=\"searchButtons\">\n  <input type=\"button\" value=\"Search\" id=\"b_searchReqFor\" class=\"templateButton\" > \n  <input type=\"button\" value=\"Clear\" id=\"b_clearReqFor\" class=\"templateButton\" > \n  <img id=\"ajax_searchReqFor\" src=\"themes/flyout/common/resources/images/spinner.gif\" alt=\"searching...\" style=\"display:none;\" />\n</div>\n<div class=\"clearfix\"></div>",
      ...
      event "Person Lookup",
        ...
        data_request "CTM:People",
          ...
          :qualification => "'Person ID' = \"<FLD>Search By Person ID;KSaef1bc5757b020f29acf55ed0f014c85c9;ANSWER</FLD>\""
    ...
    section  "Request Information",
      :style_class => " col-md-12 clearboth "
    text "Request Information Header", "<i class=\"fa fa-file-text-o fa-2x\"></i><h3 class=\"\">Request Information</h3>",
      :style_class => " section-header text-primary "
    question "Date Required", "Date Required", :date,
      :english_dates,
      :show_calendar,
      :required,
      :text_size => "20",
      ...
      :validation_text => "Date Required (Year must be four characters)",
      :field_map_number => "4"
    question "Project ID", "Project ID", :free_text,
      :size => "20",
      :rows => "1",
      :field_map_number => "2"
    question "Reason for Request", "Reason for Request", :free_text,
      :required,
      :size => "40",
      :rows => "2",
      :field_map_number => "26"
    section  "General Request",
      :style_class => " col-md-12 col-lg-11 question-section "
    text "Gen Request", "<h3 class=\"section-header sub text-primary\">General Request</h3>"
    text "Instructions", "<p class=\"text-primary subheader\">Please use the below field to provide details on your request.</p>"
    question "Request Details", "Request Details", :free_text,
      :required,
      :size => "50",
      :rows => "4",
      :field_map_number => "1"
    section  "Approval",
      :style_class => " col-md-12 question-section "
    text "Approver Label", "<h3 id=\"ApprovalLabel\" class=\"text-primary\">Approvers</h3>",
      :style_class => " section-header sub "
    question "Approving Manager", "Approving Manager", :dynamic_list,
      :required,
      :style_class => " searchableList req ",
      :field_map_number => "113" do
      bridged_dynamic_list "People",
        :qualification => "Manager and Above",
