...
<html>
    <head>
		...
		<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/doitt/css/main.css"/>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/resources/doitt/js/FuncHelper.js"></script>
